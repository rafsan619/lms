import { StandardSchemaV1, CreateEnv, StrictOptions, ServerClientOptions } from '@t3-oss/env-core';

declare const CLIENT_PREFIX: "NEXT_PUBLIC_";
type ClientPrefix = typeof CLIENT_PREFIX;
type Options<TServer extends Record<string, StandardSchemaV1>, TClient extends Record<`${ClientPrefix}${string}`, StandardSchemaV1>, TShared extends Record<string, StandardSchemaV1>, TExtends extends Array<Record<string, unknown>>> = Omit<StrictOptions<ClientPrefix, TServer, TClient, TShared, TExtends> & ServerClientOptions<ClientPrefix, TServer, TClient>, "runtimeEnvStrict" | "runtimeEnv" | "clientPrefix"> & ({
    /**
...
declare function createEnv<TServer extends Record<string, StandardSchemaV1> = NonNullable<unknown>, TClient extends Record<`${ClientPrefix}${string}`, StandardSchemaV1> = NonNullable<unknown>, TShared extends Record<string, StandardSchemaV1> = NonNullable<unknown>, const TExtends extends Array<Record<string, unknown>> = []>(opts: Options<TServer, TClient, TShared, TExtends>): CreateEnv<TServer, TClient, TShared, TExtends>;
